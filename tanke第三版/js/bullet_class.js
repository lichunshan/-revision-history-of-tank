function Bullet(tankobj){
	...
	this.isCollisionWall = function(map){
		...
		// var temp_T_L_X = parseInt((this.x+13)/16);
		// var temp_T_L_Y = parseInt((this.y-6)/16);

		// var temp_T_R_X = parseInt((this.x+16+3)/16);
		// var temp_T_R_Y = parseInt((this.y-6)/16);

		// var temp_B_L_X = parseInt((this.x+13)/16);
		// var temp_B_L_Y = parseInt((this.y+32+6)/16);

		// var temp_B_R_X = parseInt((this.x+16+3)/16);
		// var temp_B_R_Y = parseInt((this.y+32+6)/16);
